...
export default class Company extends Component {
  render() {
    return (
      <div className='container' style={{ float: "center", overflow: "hidden" }}>
        <div className="d-flex justify-content-center align-items-center">
          <div className="container-fluid">
            <div className="scrolling-wrapper row flex-row flex-nowrap mt-4 pb-4 pt-2 custom-scrollbar">
              {/* Add a class "custom-scrollbar" to apply custom styles to the scrollbar */}
              {/* slasscom */}
